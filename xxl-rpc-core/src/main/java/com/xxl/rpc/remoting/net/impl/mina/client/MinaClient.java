...
public class MinaClient extends Client {
	...
	public void asyncSend(String address, XxlRpcRequest xxlRpcRequest) throws Exception {
		// client pool
		GenericObjectPool<ClientPooled> clientPool = ClientPooled.getPool(address, MinaPooledClient.class,
				xxlRpcReferenceBean.getSerializer(), xxlRpcReferenceBean.getInvokerFactory());
		// client proxy
