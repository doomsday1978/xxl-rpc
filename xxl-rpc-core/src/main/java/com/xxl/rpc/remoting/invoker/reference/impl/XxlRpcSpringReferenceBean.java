...
public class XxlRpcSpringReferenceBean implements FactoryBean<Object>, InitializingBean {
	...
	private void init() {
		...
		// init config
		xxlRpcReferenceBean = new XxlRpcReferenceBean(netTypeEnum, serializer, callTypeEnum, loadBalanceEnum, iface,
				version, timeout, address, accessToken, invokeCallback, xxlRpcInvokerFactory);
	}
