...
public class JFinalCoreConfig extends JFinalConfig {
	...
	private void initXxlRpcServer() throws Exception {
		...
		xxlRpcProviderFactory.initConfig(NetEnum.NETTY, Serializer.SerializeEnum.HESSIAN.getSerializer(), null, 7080,
				null, XxlRegistryServiceRegistry.class, new HashMap<String, String>() {
					{
